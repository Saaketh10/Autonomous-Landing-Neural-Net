...
class GridWorldEnv(gym.Env):
    ...
    def _get_obs(self):
        return {"agent": self._agent_location, "target": self._target_location} #translates the environment into an observation
    

    def _get_info(self):
        return {"distance": np.linalg.norm(self._agent_location - self._target_location, ord=1)} #Provides distance between the agent and the target
